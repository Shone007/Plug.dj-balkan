API.chatLog("Running Radiant Music's RoomScript!", true);
function initEnvironment(){
    ...
    $('#room').append('<div class="is-leave" style="margin-top: 300px; text-align: center;"><a href="http://radiantedm.com/" target="_blank"><img src="http://i.imgur.com/hePOODi.png"></a></div>');
}
var plugCubed
initEnvironment();
/**
